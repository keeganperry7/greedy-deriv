...
def r13'' : Regex (Char) := ((Regex.plus 'a' (Regex.plus epsilon 'c'))).mul 'b'
#guard r13''.gmatch "cb" = r13''.matchEnd "cb"
...
-- b*(?=b)
def r19 : Regex Char := (star 'b' false).mul (lookahead 'b')
#guard r19.matchEnd "bb" = r19.gmatch "bb"

-- (a + ε + b)*(?=b)
def r20 : Regex (Char) := (star (plus 'a' (plus epsilon 'b')) false).mul (lookahead 'b')
#guard r20.matchEnd "bb" = r20.gmatch "bb"
...
#guard r23.gmatch "bb" = r23.matchEnd "bb"
